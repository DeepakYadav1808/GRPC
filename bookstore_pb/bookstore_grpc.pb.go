...
func (x *bookstoreGetBookdetailsClient) Send(m *ID) error {
	return x.ClientStream.SendMsg(m)
}

func (x *bookstoreGetBookdetailsClient) Recv() (*Book, error) {
	m := new(Book)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *bookstoreGetBookdetailsServer) Send(m *Book) error {
	return x.ServerStream.SendMsg(m)
}

func (x *bookstoreGetBookdetailsServer) Recv() (*ID, error) {
	m := new(ID)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
